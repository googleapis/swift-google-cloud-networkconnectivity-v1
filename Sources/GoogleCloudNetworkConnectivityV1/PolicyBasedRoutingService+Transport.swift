...
extension Clients {
  final class PolicyBasedRoutingServiceTransport: PolicyBasedRoutingServiceStub {
    ...
    public func listPolicyBasedRoutes(
      ...
      let (path, query, configure) = try {
        ...
        if let candidate = try { () throws -> (Swift.String, [URLQueryItem])? in
          ...
          let path = "/v1/\(pathVariable0)/policyBasedRoutes"
          var query = [
    ...
    public func createPolicyBasedRoute(
      ...
      let (path, query, configure) = try {
        ...
        if let candidate = try { () throws -> (Swift.String, [URLQueryItem])? in
          ...
          let encoder = GoogleGax._QueryParameterEncoder()
          query.append(
            contentsOf: try encoder.encode(request.policyBasedRouteId, prefix: "policyBasedRouteId")
          )
