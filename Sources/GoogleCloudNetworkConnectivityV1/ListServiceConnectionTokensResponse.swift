...
public struct ListServiceConnectionTokensResponse: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  GoogleCloudGax._PaginatedResponse,
  Sendable
{
  /// ServiceConnectionTokens to be returned.
  public var serviceConnectionTokens: [ServiceConnectionToken] = []
  ...
  /// Initialize a new instance of `ListServiceConnectionTokensResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListServiceConnectionTokensResponse().with { $0.serviceConnectionTokens = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let serviceConnectionTokens = CodingKeys(stringValue: "serviceConnectionTokens")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      [ServiceConnectionToken].self, forKey: .serviceConnectionTokens)
    {
      self.serviceConnectionTokens = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.serviceConnectionTokens, forKey: .serviceConnectionTokens)
