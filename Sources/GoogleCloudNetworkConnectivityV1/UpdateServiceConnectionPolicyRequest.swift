...
public struct UpdateServiceConnectionPolicyRequest: Codable, Equatable, GoogleCloudWkt._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `UpdateServiceConnectionPolicyRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = UpdateServiceConnectionPolicyRequest().with { $0.updateMask = ... }
  /// ```
