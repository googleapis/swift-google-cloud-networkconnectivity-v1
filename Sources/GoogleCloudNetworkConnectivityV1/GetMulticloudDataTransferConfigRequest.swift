...
/// resource.
public struct GetMulticloudDataTransferConfigRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `GetMulticloudDataTransferConfigRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = GetMulticloudDataTransferConfigRequest().with { $0.name = ... }
  /// ```
