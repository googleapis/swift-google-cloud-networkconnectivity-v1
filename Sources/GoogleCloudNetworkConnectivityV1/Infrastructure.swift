...
public enum Infrastructure: Codable, Equatable, Sendable {
  ...
  public var stringValue: Swift.String? {
    switch self {
    case .unspecified: return "INFRASTRUCTURE_UNSPECIFIED"
    case .psc: return "PSC"
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    switch self {
    case .unspecified: return try container.encode("INFRASTRUCTURE_UNSPECIFIED")
