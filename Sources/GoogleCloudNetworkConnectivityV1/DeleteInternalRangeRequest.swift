...
public struct DeleteInternalRangeRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `DeleteInternalRangeRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DeleteInternalRangeRequest().with { $0.name = ... }
  /// ```
