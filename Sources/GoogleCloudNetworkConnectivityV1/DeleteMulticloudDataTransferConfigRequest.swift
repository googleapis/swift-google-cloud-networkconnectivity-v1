...
public struct DeleteMulticloudDataTransferConfigRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `DeleteMulticloudDataTransferConfigRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DeleteMulticloudDataTransferConfigRequest().with { $0.name = ... }
  /// ```
