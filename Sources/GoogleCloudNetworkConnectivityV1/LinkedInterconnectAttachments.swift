...
public struct LinkedInterconnectAttachments: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `LinkedInterconnectAttachments`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = LinkedInterconnectAttachments().with { $0.uris = ... }
  /// ```
