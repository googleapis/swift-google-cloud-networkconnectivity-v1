...
public struct NextHopRouterApplianceInstance: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `NextHopRouterApplianceInstance`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = NextHopRouterApplianceInstance().with { $0.uri = ... }
  /// ```
