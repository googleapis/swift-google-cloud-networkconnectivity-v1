...
public struct ListServiceConnectionPoliciesRequest: Codable, Equatable, GoogleCloudWkt._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListServiceConnectionPoliciesRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListServiceConnectionPoliciesRequest().with { $0.parent = ... }
  /// ```
