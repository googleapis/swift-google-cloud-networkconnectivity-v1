...
public struct CreateServiceConnectionMapRequest: Codable, Equatable, GoogleCloudWkt._AnyPackable,
  Sendable
{
  ...
  public var serviceConnectionMapId: Swift.String = Swift.String()
  ...
  ///
  /// ```
  /// let value = CreateServiceConnectionMapRequest().with { $0.parent = ... }
  /// ```
