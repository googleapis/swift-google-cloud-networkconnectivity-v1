...
public struct ListHubsResponse: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// The requested hubs.
  public var hubs: [Hub] = []
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([Hub].self, forKey: .hubs) {
      self.hubs = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.hubs, forKey: .hubs)
...
extension ListHubsResponse: GoogleGax._PaginatedResponse {
