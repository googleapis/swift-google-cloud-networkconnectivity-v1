...
public struct ListDestinationsResponse: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListDestinationsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListDestinationsResponse().with { $0.destinations = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([Destination].self, forKey: .destinations) {
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.networkconnectivity.v1.ListDestinationsResponse"
  }
...
extension ListDestinationsResponse: GoogleGax._PaginatedResponse {
  public func _getPaginatedItems() -> [Destination] {
