...
public struct DeleteServiceConnectionMapRequest: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `DeleteServiceConnectionMapRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DeleteServiceConnectionMapRequest().with { $0.name = ... }
  /// ```
