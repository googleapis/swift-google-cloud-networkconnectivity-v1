...
public struct ListPolicyBasedRoutesResponse: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  GoogleCloudGax._PaginatedResponse,
  Sendable
{
  /// Policy-based routes to be returned.
  public var policyBasedRoutes: [PolicyBasedRoute] = []
  ...
  /// Initialize a new instance of `ListPolicyBasedRoutesResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListPolicyBasedRoutesResponse().with { $0.policyBasedRoutes = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let policyBasedRoutes = CodingKeys(stringValue: "policyBasedRoutes")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      [PolicyBasedRoute].self, forKey: .policyBasedRoutes)
    {
      self.policyBasedRoutes = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.policyBasedRoutes, forKey: .policyBasedRoutes)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.networkconnectivity.v1.ListPolicyBasedRoutesResponse"
  }
