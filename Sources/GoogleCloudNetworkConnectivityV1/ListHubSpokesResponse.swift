...
public struct ListHubSpokesResponse: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let spokes = CodingKeys(stringValue: "spokes")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([Spoke].self, forKey: .spokes) {
      self.spokes = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.spokes, forKey: .spokes)
...
extension ListHubSpokesResponse: GoogleGax._PaginatedResponse {
