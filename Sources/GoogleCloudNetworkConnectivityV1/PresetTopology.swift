...
public enum PresetTopology: Codable, Equatable, Sendable {
  ...
  public var stringValue: Swift.String? {
    switch self {
    case .unspecified: return "PRESET_TOPOLOGY_UNSPECIFIED"
  ...
  ///
  /// If the value is unknown, this initializes to [`unknownStringValue`](doc:PresetTopology/unknownStringValue(_:)).
  public init(stringValue: Swift.String) {
    switch stringValue {
    case "PRESET_TOPOLOGY_UNSPECIFIED": self = .unspecified
    case "MESH": self = .mesh
    case "STAR": self = .star
  ...
  ///
  /// If the value is unknown, this initializes to [`unknownIntValue`](doc:PresetTopology/unknownIntValue(_:)).
