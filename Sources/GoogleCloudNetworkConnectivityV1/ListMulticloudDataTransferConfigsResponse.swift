...
public struct ListMulticloudDataTransferConfigsResponse: Codable, Equatable, GoogleCloudWKT
    ._AnyPackable,
  GoogleCloudGax._PaginatedResponse,
  Sendable
{
  /// The list of `MulticloudDataTransferConfig` resources to be listed.
  public var multicloudDataTransferConfigs: [MulticloudDataTransferConfig] = []
  ...
  /// Initialize a new instance of `ListMulticloudDataTransferConfigsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListMulticloudDataTransferConfigsResponse().with { $0.multicloudDataTransferConfigs = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let multicloudDataTransferConfigs = CodingKeys(
      stringValue: "multicloudDataTransferConfigs")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      [MulticloudDataTransferConfig].self, forKey: .multicloudDataTransferConfigs)
    {
      self.multicloudDataTransferConfigs = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.multicloudDataTransferConfigs, forKey: .multicloudDataTransferConfigs)
