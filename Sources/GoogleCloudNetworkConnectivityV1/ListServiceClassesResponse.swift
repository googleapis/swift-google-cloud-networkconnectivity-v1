...
public struct ListServiceClassesResponse: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  GoogleCloudGax._PaginatedResponse,
  Sendable
{
  /// ServiceClasses to be returned.
  public var serviceClasses: [ServiceClass] = []
  ...
  /// Initialize a new instance of `ListServiceClassesResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListServiceClassesResponse().with { $0.serviceClasses = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let serviceClasses = CodingKeys(stringValue: "serviceClasses")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([ServiceClass].self, forKey: .serviceClasses) {
      self.serviceClasses = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.serviceClasses, forKey: .serviceClasses)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.networkconnectivity.v1.ListServiceClassesResponse"
  }
