...
public struct DeleteServiceConnectionTokenRequest: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `DeleteServiceConnectionTokenRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DeleteServiceConnectionTokenRequest().with { $0.name = ... }
  /// ```
