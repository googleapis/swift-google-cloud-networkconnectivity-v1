...
public struct ListServiceConnectionTokensRequest: Codable, Equatable, GoogleCloudWkt._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListServiceConnectionTokensRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListServiceConnectionTokensRequest().with { $0.parent = ... }
  /// ```
