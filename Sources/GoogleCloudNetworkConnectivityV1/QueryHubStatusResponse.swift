  ...
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let hubStatusEntries = CodingKeys(stringValue: "hubStatusEntries")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([HubStatusEntry].self, forKey: .hubStatusEntries) {
      self.hubStatusEntries = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.hubStatusEntries, forKey: .hubStatusEntries)
