...
public struct DeleteServiceConnectionPolicyRequest: Codable, Equatable, GoogleCloudWkt._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `DeleteServiceConnectionPolicyRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DeleteServiceConnectionPolicyRequest().with { $0.name = ... }
  /// ```
