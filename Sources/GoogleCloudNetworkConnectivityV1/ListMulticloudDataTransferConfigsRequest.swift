...
public struct ListMulticloudDataTransferConfigsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListMulticloudDataTransferConfigsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListMulticloudDataTransferConfigsRequest().with { $0.parent = ... }
  /// ```
