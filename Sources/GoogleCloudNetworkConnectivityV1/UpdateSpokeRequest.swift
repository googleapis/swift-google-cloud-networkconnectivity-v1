...
public struct UpdateSpokeRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `UpdateSpokeRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = UpdateSpokeRequest().with { $0.updateMask = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.networkconnectivity.v1.UpdateSpokeRequest"
  }
