...
public struct CreateServiceConnectionPolicyRequest: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  Sendable
{
  ...
  public var serviceConnectionPolicyId: Swift.String = Swift.String()
  ...
  /// Initialize a new instance of `CreateServiceConnectionPolicyRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = CreateServiceConnectionPolicyRequest().with { $0.parent = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let serviceConnectionPolicyId = CodingKeys(stringValue: "serviceConnectionPolicyId")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      Swift.String.self, forKey: .serviceConnectionPolicyId)
    {
      self.serviceConnectionPolicyId = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.serviceConnectionPolicyId, forKey: .serviceConnectionPolicyId)
