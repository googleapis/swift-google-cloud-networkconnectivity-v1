...
public struct ListServiceConnectionMapsRequest: Codable, Equatable, GoogleCloudWkt._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListServiceConnectionMapsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListServiceConnectionMapsRequest().with { $0.parent = ... }
  /// ```
