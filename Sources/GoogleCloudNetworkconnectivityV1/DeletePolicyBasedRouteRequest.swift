...
/// method.
///
/// [google.cloud.networkconnectivity.v1.PolicyBasedRoutingService.DeletePolicyBasedRoute]: <doc:PolicyBasedRoutingService/deletePolicyBasedRoute(request:)>
  ...
  Sendable
{
  ...
  /// Initialize a new instance of `DeletePolicyBasedRouteRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DeletePolicyBasedRouteRequest().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.networkconnectivity.v1.DeletePolicyBasedRouteRequest"
  }
