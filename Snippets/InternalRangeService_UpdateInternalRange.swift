...
func sample(
  ...
  let poller = try await client.updateInternalRange(
    withPolling: UpdateInternalRangeRequest()
      .with {
        $0.internalRange = InternalRange().with {
          $0.name =
            "projects/\(projectId)/locations/\(locationId)/internalRanges/\(internalRangeId)"
        }
