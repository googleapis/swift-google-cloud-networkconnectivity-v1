...
let package = Package(
  ...
  products: [
    .library(
      name: "GoogleCloudNetworkConnectivityV1", targets: ["GoogleCloudNetworkConnectivityV1"])
  ],
  dependencies: [
    ...
    localOrRemotePackage(
      url: "https://github.com/googleapis/swift-google-cloud-location",
      path: "generated/swift-google-cloud-location",
      from: "0.2.0"
    ),
    localOrRemotePackage(
